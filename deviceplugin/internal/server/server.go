...
import (
	...
	"openi.pcl.ac.cn/openiml/openiml/common/device/ascend"
	"openi.pcl.ac.cn/openiml/openiml/common/device/cambricon"
...
func (m *Server) Serve() error {
	...
	resourceName := fmt.Sprintf("openi.pcl.ac.cn/%s", m.device.Name())
